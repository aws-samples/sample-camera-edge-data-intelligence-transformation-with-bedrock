...
※これはOptionですのでマストの作業ではありません。
※ hlsYoloコレクターを使わず、hlsRecコレクターにDETECTORを設定しても問題ありません。違いは hlsRecの場合、全ての画像/動画に対してDETECTORを実行する一方で、hlsYoloの場合、Yoloでクラス検出/エリア侵入・退出した時だけDETECTORを実行します。
...
![1770700968173.png](image/1770700968173.png)![1770716077947.png](image/1770716077947.png)
